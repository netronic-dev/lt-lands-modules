...
import Agreement from "../LPForm/Agreement/Agreement"
import { ExtendedForm } from "../LPForm/ExtendedForm/ExtendedForm"

export function LPPopUpFormDemo(props) {
  let validate = props.ru ? validationRu : validation
  const [isAgreePrivacyPolicy, changeAgreePrivacyPolicy] = useState(true)
