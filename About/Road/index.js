      ...
      <div ref={numbersRef} key={numbersIsVisible ? 1 : 2}>
        ...
        >
          ...
          <p className={style.grid_title}>
            <CountUp start={0} end={props.cellTitle} separator=" " duration={3} />+
          </p>
          <p className={style.grid_text}>
            {props.cellText}
          </p>
        </div>
        <div className={style.grid_columns} ref={cardsRef}>
          ...
          >
            <img src="/about/vector/world.svg" />
            <p className={style.grid_title}>
              <CountUp
                delay={1}
                start={0}
                end={props.cellTwoTitle}
              />
            </p>
            <p className={style.grid_text}>
              {props.cellTwoText}
          ...
          >
            <img src="/about/vector/stars.svg" />
            <p className={style.grid_title}>
              <CountUp delay={1} start={0} end={props.cellThreeTitle} duration={1} />
            </p>
            <p className={style.grid_text}>
              {props.cellThreeText}
            </p>
          ...
          >
            <img src="/about/vector/dealers.svg" />
            <p className={style.grid_title}>
              <CountUp delay={1} start={0} end={props.cellFourTitle} duration={1} />
            </p>
            <p className={style.grid_text}>
              {props.cellFourText}
            </p>
        ...
        <div className={`${style.falcons} zoom-animation`} ref={secondLongCardRef} key={secondLongCardIsVisible ? 7 : 8}>
          <div className={`${style.clubs_image} background`}>
            <Image
          ...
          <p className={style.grid_title}>
            <CountUp start={0} end={props.cellFiveTitle} separator=" " duration={5} />+
          </p>
          <p className={style.grid_text}>
            {props.cellFiveText}
          </p>
