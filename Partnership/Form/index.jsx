				...
				<div className={style.content_wrapper}>
					<div className={style.content_info}>
						...
						<div className={style.contact_us}>
							<span className={style.hightlight_text}>{props.hightlight_text}</span>
							<div className={style.contants_wrapper}>
								<div className={style.contact_cell}>
									<span className={style.contanct_title}>{props.email_title}</span>
									<Link
								...
								<div className={style.contact_cell}>
									<span className={style.contanct_title}>{props.phone_title}</span>
									<PhoneWithLinks
...
function formatPhoneNumber(number) {
	let newNum = number.replace(/[^\d]+/g, '').replace(/(\d{1})(\d{3})(\d{3})(\d{2})(\d{2})/, '+$1 ($2) $3-$4-$5');
	return newNum;
}
