...
function Form(props) {
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            axios
                .post(
                    'https://sheet.best/api/sheets/dcf57c62-c756-459d-b106-5bb6b2b45545',
                    {
    ...
    let modelValue = `Model:${formik.values.isBasic ? 'Basic ' : ''}${
  ...
  ${
      formik.values.current_business
          ? 'current_business: ' + formik.values.current_business
          : ''
  }
  ${
      formik.values.business_to_open
          ? 'business_to_open: ' + formik.values.business_to_open
          : ''
  }
  ${modelValue}
