...
export default function AllFor(props) {
  ...
  return (
    <section className={style.all_for}
      onMouseMove={({ clientX: x, clientY: y }) => set({ xy: calc(x, y) })}
    >
      <h2 className={`${style.title} fade-up-animation`} ref={titleRef} key={isTitleVisible ? "all_for_title" : null}>
        {props.title}
      </h2>
        ...
        <div className={style.content_in}>
          <div className={style.bg_img}>
            <animated.div
              ...
              <Image layout="intrinsic" src="/mobileClub/start-bg.png" width={385} height={416} />
            </animated.div>
          </div>
          <div className={style.grid} ref={gridRef}>
            <div className={`${style.cell} zoom-animation`} key={isGridVisible ? "all_for_cell_1" : 1}>
            ...
            <div className={`${style.cell} zoom-animation animated-second`} key={isGridVisible ? "all_for_cell_2" : 2}>
              <div className={style.cell_image}>
                <Image
            ...
            <div className={`${style.cell} zoom-animation animated-third`} key={isGridVisible ? "all_for_cell_3" : 3}>
              <div className={style.cell_image}>
                <Image
          ...
          <div className={`${style.form_block} fade-right-animation`} key={isGridVisible ? "all_for_form" : null}>
