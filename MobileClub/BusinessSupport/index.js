...
export default function MCBusinessSupport(props) {
    ...
    return (
        <section className={style.bis_sup}>
            <h2
            ...
            <div className={style.grid}>
                ...
                >
                    <img className={style.cell__icon} src={props.cell4Image} />
                ...
                >
                    <img className={style.cell__icon} src={props.cell3Image} />
                ...
                >
                    <img className={style.cell__icon} src={props.cell1Image} />
                ...
                >
                    <img className={style.cell__icon} src={props.cell2Image} />
                    <h3 className={style.cell__title}>{props.cell4Title}</h3>
                    <p className={style.cell__text}>{props.cell4Text}</p>
                </div>
                <div
                    className={`${style.long_cell} ${style.long} zoom-animation animated-fivth`}
                    key={isVisible ? 'bis_sup_5-inview' : 'bis_sup_5'}
                >
                    <div className={style.long_cell__content}>
                        <p className={style.long_cell__text}>
                            {quotLeft}
                            {props.cell5Text}
                            {quotRight}
                        </p>
                        <h3 className={style.long_cell__title}>
                            {props.cell5Title}
                        </h3>
                    </div>
                    <div className={style.long_cell__image}>
                        <Image
            ...
            <div
                className={`${style.cta} zoom-animation`}
                ref={cellRef}
                key={isCellVisible ? 'cta-inview' : 'cta'}
            >
                <div className={style.cta__text_block}>
                    <h3 className={style.cta__title}>{props.cell6Title}</h3>
                    <p className={style.cta__text}>{props.cell6Text}</p>
                    <BUTTON
                ...
                <div className={`${style.cta__image_res}`}>
                    <Image
                        quality={90}
...
const quotLeft = (
    ...
    >
        <path
            d='M4.64062 0.203125L7.82812 2.05469C6.48438 4.17969 5.78906 6.33594 5.74219 8.52344V12.4375H0.375V8.92188C0.375 7.45312 0.78125 5.89063 1.59375 4.23438C2.42188 2.5625 3.4375 1.21875 4.64062 0.203125ZM12.6797 0.203125L15.8672 2.05469C14.5234 4.17969 13.8281 6.33594 13.7812 8.52344V12.4375H8.41406V8.92188C8.41406 7.45312 8.82031 5.89063 9.63281 4.23438C10.4609 2.5625 11.4766 1.21875 12.6797 0.203125Z'
            fill='black'
        />
    </svg>
);
const quotRight = (
    ...
    >
        <path
            d='M11.3594 12.7969L8.17188 10.9453C9.51563 8.82031 10.2109 6.66406 10.2578 4.47656L10.2578 0.562498L15.625 0.562499L15.625 4.07812C15.625 5.54687 15.2188 7.10937 14.4063 8.76562C13.5781 10.4375 12.5625 11.7812 11.3594 12.7969ZM3.32031 12.7969L0.132813 10.9453C1.47656 8.82031 2.17188 6.66406 2.21875 4.47656L2.21875 0.562497L7.58594 0.562498L7.58594 4.07812C7.58594 5.54687 7.17969 7.10937 6.36719 8.76562C5.53906 10.4375 4.52344 11.7812 3.32031 12.7969Z'
            fill='black'
        />
    </svg>
);
