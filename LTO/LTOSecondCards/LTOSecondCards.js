      ...
      <div className={style.grid_personal_statistics}>
        ...
        >
          ...
          <div className={`${style.card_left__img} zoom-animation`}>
            ...
            <div className={style.image}>
              <Image
                src={props.firstImage ? props.firstImage : "/lasertagOperator/statistics.png"}
                layout="responsive"
                width={365}
                height={375}
              />
        ...
        >
          <div className={`${style.image} zoom-animation`}>
            <Image
              src={props.secondImage ? props.secondImage : "/lasertagOperator/aloneimage.png"}
              layout="responsive"
              width={310}
              height={620}
            />
        ...
        <div
          ...
          <div className={`${style.nonGrid__img} zoom-animation`}>
            <div className={style.nonGrid__img_in}>
              <Image
                src={props.thirdImage ? props.thirdImage : "/lasertagOperator/performanceIndicators.png"}
                layout="responsive"
                width={1200}
                height={390}
              />
