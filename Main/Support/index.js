        ...
        <div className={style.support_grid} ref={ref}>
          ...
          >
            <div className={style.card_content}>
              <h3 className={style.card_title}>{props.firstCardTitle}</h3>
              <p className={style.card_text}>{props.firstCardText}</p>
            </div>
            <Image
          ...
          >
            <div className={style.card_content}>
              <h3 className={style.card_title}>{props.secondCardTitle}</h3>
              <p className={style.card_text}>{props.secondCardText}</p>
            </div>
            <Image
