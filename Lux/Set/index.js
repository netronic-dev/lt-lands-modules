    ...
    <section className={style.lux_set_out}>
      <div className={style.lux_set}>
        ...
        <table className={style.set_table_responsive}>
          <tr>
            <td className={style.table_title}>{props.tabTitleOne}</td>
            <td className={style.plus_blue}>
              {props.data[activeCell].firstCell ? "+" : ""}
            </td>
          </tr>
          <tr>
            <td className={style.table_title}>{props.tabTitleTwo}</td>
            <td className={style.plus_blue}>
              {props.data[activeCell].secondCell ? "+" : ""}
            </td>
          </tr>
          <tr>
            <td className={style.table_title}>{props.tabTitleThree}</td>
            <td className={style.plus_blue}>
              {props.data[activeCell].thirdCell ? "+" : ""}
            </td>
          </tr>
          <tr>
            <td className={style.table_title}>{props.tabTitleFour}</td>
            <td className={style.plus_blue}>
              {props.data[activeCell].fourthCell ? "+" : ""}
            </td>
          </tr>
          <tr>
            <td className={style.table_title}>{props.tabTitleFive}</td>
            <td className={style.plus_blue}>
              {props.data[activeCell].fivthCell ? "+" : ""}
            </td>
          </tr>
          <tr>
            <td className={style.table_title}>{props.tabTitleSix}</td>
            <td className={style.plus_blue}>
          ...
          {props.tabTitleSeven && (
            <tr>
              <td className={style.table_title}>{props.tabTitleSeven}</td>
              <td className={style.plus_blue}>
                {props.data[activeCell].seventhCell}
              </td>
            </tr>
          )}
          {props.tabTitleEight && (
            <tr>
              <td className={style.table_title}>{props.tabTitleEight}</td>
              <td className={style.plus_blue}>
                {props.data[activeCell].eighthCell}
              </td>
            </tr>
          )}
          {props.tabTitleNine && (
            <tr>
              <td className={style.table_title}>{props.tabTitleNine}</td>
              <td className={style.plus_blue}>
                {props.data[activeCell].ninthCell}
              </td>
            </tr>
          )}
          {props.tabTitleTen && (
            <tr>
              <td className={style.table_title}>{props.tabTitleTen}</td>
              <td className={style.plus_blue}>
                {props.data[activeCell].tenthCell}
              </td>
            </tr>
          )}
          {props.tabTitleEleven && (
            <tr>
              <td className={style.table_title}>{props.tabTitleEleven}</td>
              <td className={style.plus_blue}>
                {props.data[activeCell].eleventhCell}
              </td>
            </tr>
          )}
        </table>
        <table className={style.set_table}>
          <thead>
            {props.only_premium ? (
              <tr>
                <th>{props.tableTitle ? props.tableTitle : ""}</th>
