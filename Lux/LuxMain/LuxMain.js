    ...
    >
      ...
      <div className={style.main_content}>
        ...
        <div className={style.main_content__bottom}>
          ...
          <PriceButton style="black" catalog text={props.buttonText} en={props.en} />
        </div>
      </div>
    </section>
  )
...
const luxLogo = (
  <svg width="688" height="1315" viewBox="0 0 688 1315" fill="none" >
    ...
    <defs>
      <filter id="filter0_f" x="0" y="57" width="688" height="1258" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
      ...
      <linearGradient id="paint0_linear" x1="327.5" y1="111" x2="315.766" y2="1043.85" gradientUnits="userSpaceOnUse">
        <stop stop-color="#24A4EC" />
        <stop offset="0.494792" stopColor="#ADA0FB" />
        <stop offset="0.916667" stopColor="#E1D3FF" stop-opacity="0" />
      </linearGradient>
    </defs>
  </svg>
