...
export default function PulseIllumination(props) {
  ...
  return (
    ...
    >
      <h2 className="fade-up-animation">
        {props.title}
      </h2>
      <div className={style.cards_illumination}>
        <div className={`${style.laserRay_text_mob} zoom-animation`}>
          ...
          <Image src="/GalaxyPulse/laser.jpg"
            layout="responsive"
            width={491}
            height={655}
          />
        ...
        <div className={`${style.backlightHousing_mob} zoom-animation`}>
          ...
          <Image src="/GalaxyPulse/blustercloser-mob.jpg"
            layout="responsive"
            width={433}
            height={491}
          />
        </div>
        <div className={`${style.backlightHousing} zoom-animation animated-second`}>
          <div className="background_image">
            <Image
              objectFit="cover"
