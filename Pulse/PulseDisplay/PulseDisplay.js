  ...
  return (
    <>
      <div className={style.section_oled}>
        ...
        <div className={style.section_oled_inside}>
          ...
          <div className={style.section_oled_grid}>
            <div>
              <img src="/GalaxyPulse/game-indicators.svg" />
              <p className="paragraph">
                {props.cellText}
              </p>
            </div>
            <div>
              <img src="/GalaxyPulse/screen.svg" />
              <p className="paragraph">
                {props.cellTwoText}
              </p>
            </div>
            <div>
              <img src="/GalaxyPulse/glass.svg" />
              <p className="paragraph">
                {props.cellThreeText}
              </p>
            </div>
      ...
      <div className={style.section_oled_mob}>
        ...
        <h2 className={style.section_oled_title}>
          {props.title}
        </h2>
        <div className={style.section_oled_grid_mob}>
          <div>
            <img
              src="/GalaxyPulse/game-indicators.svg"
            />
            <p className="paragraph">
              {props.cellText}
            </p>
